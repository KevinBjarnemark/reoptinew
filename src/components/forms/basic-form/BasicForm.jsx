    ...
    return (
        <div className="flex-column-relative">
            ...
            <label 
                ...
                style={{
                    backgroundColor: previewImg ? "var(--color-image-background)" : "#ffffff",
...
const Checkbox = (props) => {
    ...
    return (
        <div className="flex-row-relative align-items-center 
...
const ErrorMessage = (props) => {
    ...
    return (
        <p 
            className={`${style["error-message"]} mt-5`}>
            {text}
        </p>
    );
};
...
export const BasicForm = (props) => {
    ...
    return (
    <form className="flex-column-relative align-items-center mt-4 mb-4 w-100">
        {children}
